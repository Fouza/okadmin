...
class Food extends Component {
  ...
  async getCategoriesExercises() {
    ...
    await axios.get(`http://c4216fbecb77.ngrok.io/api/service/categoriesFood/listCategoriesFood`,
      config).then(
        res => {
  ...
  async addCategorieExercise() {
    ...
    await axios.post(`http://c4216fbecb77.ngrok.io/api/service/catgeorieFood/addCategoryFood`,
      {
  ...
  async modifierCategorieExercise(id) {
    ...
    await axios.put(`http://c4216fbecb77.ngrok.io/api/service/catgeorieFood/updateCategoryFood/${this.state.cat_id}`,
      {
